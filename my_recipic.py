...
@app.route('/paik_rand_official_recipes', methods=['GET'])
def random_recipes():
    ...
    for repeat in range(10):
        ...
        recommend_recipes = (random.sample(random_recipe, 40)) #max = 80개씩 뿌릴수 있음

    return jsonify({'result': 'success', 'recommend_recipes': recommend_recipes})
